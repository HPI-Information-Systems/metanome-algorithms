...
public class DVPCSA extends DVPCSAAlgorithm implements BasicStatisticsAlgorithm, RelationalInputParameterAlgorithm, StringParameterAlgorithm  {
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if (!DVPCSA.Identifier.INPUT_GENERATOR.name().equals(identifier))
			throw new AlgorithmConfigurationException("Input generator does not match the expected identifier: " + identifier + " (given) but " + DVPCSA.Identifier.INPUT_GENERATOR.name() + " (expected)");
	...
	@Override
	  public void setStringConfigurationValue(String identifier, String... values)
	    ...
	    if (DVPCSA.Identifier.STANDARD_ERROR.name().equals(identifier))
	    {
  ...
  public String getDescription() {
    ...
    return "Probabilistic Counting with Stochastic Averaging Estimator. Flajolet, P., & Martin, G. N. (1985). Probabilistic counting algorithms for data base applications. Journal of computer and system sciences, 31(2), 182-209.";
  }
