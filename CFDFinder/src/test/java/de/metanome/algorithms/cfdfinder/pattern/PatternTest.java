...
public class PatternTest {
    ...
    public void testPatternEquality() {
        ...
        attributes2.put(Integer.valueOf(0), new VariablePatternEntry());
        attributes2.put(Integer.valueOf(1), new ConstantPatternEntry(2));
        attributes2.put(Integer.valueOf(2), new ConstantPatternEntry(4));
        ...
        attributes3.put(Integer.valueOf(0), new VariablePatternEntry());
        attributes3.put(Integer.valueOf(1), new ConstantPatternEntry(3));
        attributes3.put(Integer.valueOf(2), new ConstantPatternEntry(5));
