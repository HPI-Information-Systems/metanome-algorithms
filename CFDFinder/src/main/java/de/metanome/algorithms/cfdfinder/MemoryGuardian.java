...
public class MemoryGuardian {
	...
	public void match(de.metanome.algorithms.cfdfinder.structures.FDSet negCover, de.metanome.algorithms.cfdfinder.structures.FDTree posCover, FDList newNonFDs) {
