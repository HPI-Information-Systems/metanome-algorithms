package de.hpi.metanome.algorithms.hyfd.fixtures;
...
public class AlgorithmTestFixture11 extends AbstractAlgorithmTestFixture {
	...
	public AlgorithmTestFixture11() throws CouldNotReceiveResultException {
		...
		this.table.add(ImmutableList.of("1", "2", "1", "2"));
		this.table.add(ImmutableList.of("1", "2", "2", "2"));
		this.table.add(ImmutableList.of("1", "2", "3", "3"));
