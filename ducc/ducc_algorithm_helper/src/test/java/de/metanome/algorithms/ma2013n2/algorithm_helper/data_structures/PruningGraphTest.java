...
public class PruningGraphTest {
  ...
  public void addTestOverflow() {
    ...
    assertEquals(actualColumnCombinationAB,
                 graph.columnCombinationMap.get(actualColumnCombinationAB).get(0));

    assertEquals(1, graph.columnCombinationMap.get(actualColumnCombinationBC).size());
    assertEquals(actualColumnCombinationBC,
                 graph.columnCombinationMap.get(actualColumnCombinationBC).get(0));

    assertEquals(1, graph.columnCombinationMap.get(actualColumnCombinationBD).size());
    assertEquals(actualColumnCombinationBD,
                 graph.columnCombinationMap.get(actualColumnCombinationBD).get(0));
  }

  /**
   * Test method for {@link PruningGraph#find(ColumnCombinationBitset)} <p/> TODO docs
   */
  @Test
