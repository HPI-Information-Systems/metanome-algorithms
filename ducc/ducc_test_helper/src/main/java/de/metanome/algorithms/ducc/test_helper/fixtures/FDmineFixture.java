...
//			}).when(uccResultReceiver).receiveResult(isA(UniqueColumnCombination.class));
  ...
  public void verifyFunctionalDependencyResultReceiver() throws CouldNotReceiveResultException {
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA), expectedIdentifierD));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierB), expectedIdentifierE));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierC), expectedIdentifierF));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierD), expectedIdentifierA));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierD, expectedIdentifierE),
                                 expectedIdentifierC));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierD, expectedIdentifierE),
                                 expectedIdentifierF));
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierC, expectedIdentifierE),
                                 expectedIdentifierA));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierC, expectedIdentifierE),
                                 expectedIdentifierD));
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierE),
                                 expectedIdentifierC));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierE),
                                 expectedIdentifierF));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierB),
                                 expectedIdentifierC));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierB),
                                 expectedIdentifierF));
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierF),
                                 expectedIdentifierB));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierF),
                                 expectedIdentifierE));
    ...
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierC),
                                 expectedIdentifierB));
    verify(functionalDependencyResultReceiver, atLeastOnce()).receiveResult(
        new FunctionalDependency(new ColumnCombination(expectedIdentifierA, expectedIdentifierC),
                                 expectedIdentifierE));
