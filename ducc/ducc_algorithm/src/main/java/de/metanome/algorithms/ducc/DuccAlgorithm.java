...
public class DuccAlgorithm {
    ...
    public DuccAlgorithm(String relationName, List<String> columnNames, UniqueColumnCombinationResultReceiver uccReceiver) {
    ...
    public DuccAlgorithm(String relationName, List<String> columnNames, UniqueColumnCombinationResultReceiver uccReceiver, Random random) {
    ...
    /**
     * Method that sets the desired raw key error for unique checks.
     * Default is 0. If set to a value different to 0, partial uniques are found.
     *
     * @param keyError
     */
