...
public class UccGraphTraverser extends GraphTraverser {
    ...
    public void init(List<PositionListIndex> basePLIs, UniqueColumnCombinationResultReceiver resultReceiver, String relationName, List<String> columnNames) throws CouldNotReceiveResultException {
    ...
    protected void filterNonUniqueColumnCombinationBitsets(List<PositionListIndex> basePLIs) throws CouldNotReceiveResultException {
        int columnIndex = 0;
        ...
        for (PositionListIndex pli : basePLIs) {
            ...
            if (isUnique(pli)) {
                ...
                this.resultReceiver.receiveResult(new UniqueColumnCombination(new ColumnIdentifier(this.relationName, columnNames.get(columnIndex))));
            } else {
