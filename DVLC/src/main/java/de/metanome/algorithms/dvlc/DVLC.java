...
public class DVLC extends DVLCAlgorithm implements BasicStatisticsAlgorithm,
  ...
  public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() {
    ...
    conf.add(new ConfigurationRequirementRelationalInput(DVLC.Identifier.INPUT_GENERATOR.name()));
    ConfigurationRequirementString inputstandard_error =
        new ConfigurationRequirementString(DVLC.Identifier.STANDARD_ERROR.name());
  ...
  public void setRelationalInputConfigurationValue(String identifier,
    ...
    if (!DVLC.Identifier.INPUT_GENERATOR.name().equals(identifier))
      throw new AlgorithmConfigurationException(
          "Input generator does not match the expected identifier: " + identifier + " (given) but "
              + DVLC.Identifier.INPUT_GENERATOR.name() + " (expected)");
  ...
  public void setStringConfigurationValue(String identifier, String... values)
    ...
    if (DVLC.Identifier.STANDARD_ERROR.name().equals(identifier)) {
